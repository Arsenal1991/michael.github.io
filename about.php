...
<!-- Navigation -->
    ...
    <div class="container">
        ...
        <!-- Jumbotron Header -->
        <header class="jumbotron about-display">
        <h1> about </h1>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3>SnackShack is protein / health bar supplement store. </h3>
                </br>
                <h3> We offer three different size boxes that you cn choose from. Five, Seven and Ten.</h3>
            </div>
        </div>
